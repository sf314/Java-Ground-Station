...
Other note for window users:
In order to compile and run java code, you'll need the JRE (Java Runtime
Environment) and the JDK (Java Development Kit). Download and install them.
Check that they're available by running:
    `where java.exe`
    `where javac.exe`
in your Command Prompt. If they're not found, check your environment variables
and ask me about it (or just google it!).
